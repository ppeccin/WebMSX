...
wmsx.DiskImages = function() {
    ...
    this.FORMAT_OPTIONS_MEDIA_TYPES = [0xF8, 0xF9];

    this.MEDIA_TYPE_DESC = {0xF8: "360KB", 0xF9: "720KB"};

    this.MEDIA_TYPE_DISK_SIZE = {0xF8: 360 * 1024, 0xF9: 720 * 1024};
    ...
    this.MEDIA_TYPE_FAT_START = {0xF8: [0xF8, 0xFF, 0xFF], 0xF9: [0xF9, 0xFF, 0xFF]};
