    ...
    function registerWrite(reg, val) {
        ...
        switch (reg) {
            ...
            case 1:
                ...
                if ((val & 0x40) !== (old & 0x40)) pendingBlankingChange = true;            // BL, only at next line
