...
wmsx.JoysticksControls = {
    ...
    PADDLE1_POSITION: 0x10001, PADDLE1_BUTTON1: 0x10002, PADDLE1_BUTTON2: 0x10003, 	// Position from 380 (Left) to 190 (Center) to 0 (Right); -1 = disconnected, won't charge POTs
